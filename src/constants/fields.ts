...
const common: FieldMap = {
  ...
  gtr_name:           { label: 'Группа товаров',     short: 'Группа'     },
  ...
  qual_type:          { label: 'Тип качества',       short: 'Качество'   },
  ...
  indoc_id:           { label: 'Номер документа',    short: 'Номер'      },
  indoc_type_descrip: { label: 'Тип документа',      short: 'Тип'        },
  indoc_txt:          { label: 'Примечание',         short: 'Примечание' },
  outdoc_id:          { label: 'Номер документа',    short: 'Номер'      },
